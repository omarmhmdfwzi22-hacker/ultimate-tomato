...
import { Search, ArrowUpRight, ArrowRight, FolderGit2, ExternalLink } from 'lucide-react';
          ...
          {filteredProjects.map((project) => (
            ...
            >
                ...
                <div className="absolute top-4 right-4 z-10">
                  {project.project_url ? (
                    <a
                      ...
                      className="p-2.5 rounded-full bg-black/70 backdrop-blur-md text-white hover:bg-[#F52F3A] transition-colors inline-flex items-center justify-center shadow-lg"
                      title="Open Live Project URL"
                    >
                      <ExternalLink className="w-4 h-4" />
                    </a>
                  ) : (
                    <span className="p-2.5 rounded-full bg-black/70 backdrop-blur-md text-white group-hover:bg-[#F52F3A] transition-colors inline-flex items-center justify-center">
              ...
              <div className="p-6 sm:p-7 flex-1 flex flex-col justify-between space-y-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-black/[0.04] dark:border-white/[0.06]">
                  ...
                  {project.project_url ? (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="inline-flex items-center justify-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#F52F3A] hover:bg-[#d9232d] text-white text-xs font-semibold shadow-md shadow-[#F52F3A]/20 transition-all flex-shrink-0"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full bg-zinc-100 dark:bg-white/5 text-zinc-700 dark:text-zinc-300 text-xs font-semibold hover:bg-zinc-200 dark:hover:bg-white/10 transition-all flex-shrink-0"
                    >
